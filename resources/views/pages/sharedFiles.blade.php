...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Mes Fichiers partagés</h1>
        </div>
    </div><!--//row-->
</div><!--//row-->
<div class="row g-4">
            ...
            <div class="app-card-body p-3 has-card-actions">
                ...
                <div class="app-doc-meta">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><span class="text-muted">Taille:</span> 512KB</li>
                        <li><span class="text-muted">Uploaded:</span> 06/12/2024</li>
                    </ul>
                </div><!--//app-doc-meta-->
